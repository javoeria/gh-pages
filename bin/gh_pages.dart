...
void main(List<String> arguments) {
  ...
  parser.addOption('dist', abbr: 'd', help: 'Base directory for all source files', defaultsTo: 'build');
  // parser.addOption('src', abbr: 's', help: 'Pattern used to select which files to publish', defaultsTo: '**/*');
  parser.addOption('branch', abbr: 'b', help: 'Name of the branch you are pushing to', defaultsTo: 'gh-pages');
  ...
  parser.addOption('message', abbr: 'm', help: 'Commit message', defaultsTo: 'Updates');
  ...
  parser.addOption('remote', abbr: 'o', help: 'The name of the remote', defaultsTo: 'origin');
  ...
  parser.addFlag('no-push', abbr: 'n', help: 'Commit only (with no push)', negatable: false);
  parser.addFlag('no-history', abbr: 'f', help: 'Push force new commit without parent history', negatable: false);
